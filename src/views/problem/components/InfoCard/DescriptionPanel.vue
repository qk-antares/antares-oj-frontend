<template>
  <div class="overflow-auto px-4 py-5 select-text" style="height: calc(100vh - 96px)">
    <a-space direction="vertical" size="medium">
      ...
      <a-space :size="[40, 8]">
        ...
        <div v-if="['已通过', '尝试过'].includes(problem.status)" class="flex items-center text-base">
          <span class="mr-1 text-gray-500">{{ problem.status }}</span>
          <SolvedIcon v-if="problem.status === ProblemStatusEnum.SOLVED" class="text-solved mt-[2px]" />
